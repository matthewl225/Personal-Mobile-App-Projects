...
public final class NetworkUtils {
    ...
    private static final String APP_ID_KEY = "d19d9d12841abab3af992523293db17b";
    ...
    public static URL buildUrl(String locationQuery) {
        ...
        Uri builtUri = Uri.parse(OPEN_WEATHER_URL).buildUpon()
                .appendQueryParameter(QUERY_PARAM, locationQuery)
                .appendQueryParameter(FORMAT_PARAM, format)
                .appendQueryParameter(UNITS_PARAM, units)
                .appendQueryParameter(DAYS_PARAM, Integer.toString(14))
                .appendQueryParameter(KEY, APP_ID_KEY)
                .build();
